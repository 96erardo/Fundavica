...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_instafeed_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_froala_editor_js_froala_editor_pkgd_min_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_froala_editor_js_froala_editor_pkgd_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_froala_editor_js_froala_editor_pkgd_min_js__);
 ...
 */
var instagramTemplate = '<div class="column is-4 instagram">' + '<div class="card-plain">' + '<div class="card-image">' + '<figure class="image is-1by1">' + '<a href="{{link}}" target="_blank">' + '<img src="{{image}}" />' + '</a>' + '</figure>' + '</div>' + '<div class="card-content insta">' + '<h3 class="subtitle" style="margin-botton: 5px;">' + '<i class="fa fa-heart-o" aria-hidden="true" style="margin-right: 5px;"></i>' + '<i class="fa fa-comment-o" aria-hidden="true" style="margin-right: 5px;"></i>' + '<i class="fa fa-paper-plane-o" aria-hidden="true" style="margin-right: 5px;"></i>' + '</h3>' + '<h6 class="subtitle is-6" style="margin: 5px 0px;">{{comments}} comentarios</h6>' + '<h6 class="subtitle is-6" style="margin: 5px 0px;"><strong>gerardoagl96</strong> {{caption}}</h6>' + '</div>' + '</div>' + '</div>';
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
     ...
     */
    var $profile_button = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.profile-button');
    var $profile_modal = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#profile-modal');
     ...
     */
    var feed = new __WEBPACK_IMPORTED_MODULE_1_instafeed_js___default.a({
        get: 'user',
        userId: '595939559',
    ...
    var optg = {
        height: 400,
        toolbarButtons: ['bold', 'italic', 'underline', 'strikeThrough', 'paragraphFormat', '|', 'formatOL', 'formatUL', 'quote', 'insertTable', '|', 'insertLink', 'insertImage', 'insertVideo', '-', 'selectAll', 'clearFormatting', 'undo', 'redo'],
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#froala').froalaEditor(optg);

    /**
     * Eliminar las notificaciones que aparezcan en pantalla
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button.delete').click(function (event) {
        event.preventDefault();
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(event.target).closest('div.notification').remove();
    });

    /**
     * Mostrar el textarea del comentario cuando se desea editar 
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.media a.edt').click(function (event) {
        event.preventDefault();

        var $comment = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(event.target).closest('article.media');
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.comment button.cnl').click(function (event) {
        event.preventDefault();

        var $textarea = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(event.target).closest('div.comment');
     ...
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('a.del').click(function (event) {
        event.preventDefault();

        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#delete-modal').toggleClass('is-active');
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#delete-button').attr('href', __WEBPACK_IMPORTED_MODULE_0_jquery___default()(event.delegateTarget).attr('href'));
    });

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#delete-modal').find('.delete-button').click(function (event) {
        event.preventDefault();
     ...
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('div.dropdown').click(function (event) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(event.delegateTarget).toggleClass('is-active');
    });
});
